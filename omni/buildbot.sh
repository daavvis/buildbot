...
# What version of android? (you only need to fill this out if you answered "y" to the question above)
...
FTPHOST[0]=	# ftp hostname
FTPUSER[0]=	# ftp username 
FTPPASS[0]=	# ftp password
